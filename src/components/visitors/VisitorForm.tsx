    ...
    <div className="max-w-2xl mx-auto p-6">
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label htmlFor="modeOfEntry" className="block text-xs font-medium text-gray-700 mb-1">Mode of Entry</label>
            <select
              id="modeOfEntry"
              name="modeOfEntry"
              ...
              onChange={handleChange}
              required
              className="block w-full px-3 py-2 border rounded focus:outline-none focus:ring-primary-500"
            >
            ...
            {errors.modeOfEntry && <p className="text-xs text-red-500 mt-1">{errors.modeOfEntry}</p>}
          </div>
